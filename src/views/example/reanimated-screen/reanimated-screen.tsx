...
export interface ReanimatedScreenProps extends NavigationScreenProps<{}> {}

export class ReanimatedScreen extends React.Component<ReanimatedScreenProps, {}> {
        ...
        <SafeAreaView style={FULL}>
          <Screen style={CONTAINER} backgroundColor={color.transparent} preset="scrollStack">
            ...
            <Text style={TITLE_WRAPPER}>
              <Text style={ALMOST} text="Reanimated" />
            </Text>
            <Text style={CONTENT}>
